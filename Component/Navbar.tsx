    ...
    <header className="w-full border-b bg-white sticky top-0 z-50">
      <nav className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <ul className="hidden md:flex items-center gap-6 text-gray-600 font-medium">
          ...
          <li><Link href="/ecom">Products</Link></li>
          <li><Link href="/ecom/about">About</Link></li>
          <li><Link href="/ecom/contact">Contact Us</Link></li>
          {session?.user?.email === 'nayyarhussain125@gmail.com' && <li><Link href="/dashboard">Dashboard</Link></li> }
        ...
        <div className="flex items-center gap-4">
          ...
          <div >
           {
            session?.user?.image ? <Image className="rounded cursor-pointer" src={session?.user?.image} alt="profile" width={40} height={40}/>
            :
            <Link href={'/'}>
